...
result = 100/77
print("The result is {r:10.4f}".format(r = result))               # print("statement {value:width.precision}").format(result))
...
width = 10
result = 100/77
print(f"The result is {result:{width}.4f} ")                         # print(f"statement {value:{width}.{precision}})
